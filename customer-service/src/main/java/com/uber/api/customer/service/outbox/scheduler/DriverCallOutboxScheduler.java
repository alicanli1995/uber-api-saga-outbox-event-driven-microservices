...
public class DriverCallOutboxScheduler implements OutboxScheduler {

    private final RequestOutboxHelper callOutboxHelper;

    private final CallDriverRequestMessagePublisher callDriverRequestMessagePublisher;
    ...
    public void processOutboxMessage() {
        ...
        if (Objects.nonNull(outboxMessages) && !outboxMessages.isEmpty()) {
            ...
            outboxMessages.forEach(callOutboxMessage ->
                    callDriverRequestMessagePublisher.publish(callOutboxMessage,this::updateOutboxStatus));
            }
        }

    private void updateOutboxStatus(DriverApprovalOutbox driverApprovalOutbox,
