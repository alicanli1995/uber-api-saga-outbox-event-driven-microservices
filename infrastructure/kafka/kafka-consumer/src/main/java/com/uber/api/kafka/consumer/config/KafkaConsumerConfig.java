package com.uber.api.kafka.consumer.config;

import com.uber.api.outbox.kafka.config.data.KafkaConfigData;
import com.uber.api.outbox.kafka.config.data.KafkaConsumerConfigData;
